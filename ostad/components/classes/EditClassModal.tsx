...
export default function EditClassModal({ classItem }: EditClassModalProps) {
    ...
    const [cycle, setCycle] = useState(classItem.cycle || 'CEM')
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md relative z-10 overflow-hidden flex flex-col max-h-[90vh]">
                <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-white sticky top-0">
                    <h2 className="text-xl font-bold text-gray-900">Modifier la Classe</h2>
                    <button
                        onClick={handleClose}
                ...
                <div className="p-6 overflow-y-auto">
                    <form id="editClassForm" onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2">Nom de la classe <span className="text-red-500">*</span></label>
                            <input
                                type="text"
                                value={name}
