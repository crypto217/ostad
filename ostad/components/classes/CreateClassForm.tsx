...
const COLORS = [
    ...
    { name: 'Rose', value: 'bg-pink-400', code: 'pink' },
    ...
    if (isSuccess) {
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center animate-in fade-in zoom-in duration-300">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Classe Créée !</h2>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-3">
                    <label htmlFor="className" className="text-sm font-bold text-gray-700 ml-1">
                        Nom de la classe
                    </label>
                    <input
                        id="className"
                        ...
                        placeholder="ex: 3ème A, Mathématiques..."
                        className="w-full px-5 py-4 bg-white border-2 border-gray-100 rounded-2xl focus:border-green-400 outline-none transition-all text-lg font-medium shadow-sm"
                        required
                    />
                </div>
