...
export default function Onboarding() {
    ...
    // En option, rediriger si le profil existe déjà
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-[#F9F9F6] flex items-center justify-center p-4 font-sans py-12">
            <div className="w-full max-w-xl bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-gray-700">
                    ...
                    <button
                        ...
                        className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-4 rounded-3xl transition-colors mt-8 flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed shadow-sm"
                    >
